...
from raphael_graph.routes import router
...
app = FastAPI(title="raphael-graph", version="0.1.0", lifespan=lifespan)
app.include_router(router, prefix="/v1/graph")


@app.get("/health")
def health() -> dict[str, str]:
    return {"status": "ok", "service": "raphael-graph"}
